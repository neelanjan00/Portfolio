        ...
        return (
            <React.Fragment>
                ...
                { sidebarState.sidebarDisplay === 'block' ? (
                    <div style={{ zIndex: '2', minHeight: '100vh', width: '65vw',
                                  backgroundColor: 'black', position: 'fixed' }}>
                        <Link to="/">
                            <div style={{padding: '10px'}}>
                                <div style={{ backgroundColor: props.source === 'home' ? '#102330' : 'black', 
                                            color: 'white', 
                                            borderRadius: '10px',
                                            textAlign: 'center',
                                            padding: '13px'}}>
                        ...
                        <Link to="/blogs">
                            <div style={{padding: '10px'}}>
                                <div style={{ backgroundColor: props.source === 'blogs' ? '#102330' : 'black', 
                                            color: 'white', 
                                            textAlign: 'center',
                                            borderRadius: '10px',
                                            padding: '13px' }}>
                        ...
                        <Link to="/projects">
                            <div style={{padding: '10px'}}>
                                <div style={{ backgroundColor: props.source === 'projects' ? '#102330' : 'black', 
                                            color: 'white', 
                                            textAlign: 'center',
                                            borderRadius: '10px', 
                                            padding: '13px' }}>
